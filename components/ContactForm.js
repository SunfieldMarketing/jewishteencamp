    ...
    return (
      <div className="text-center py-12 px-6">
        ...
        <p className="text-gray-600 mb-6">
          We&apos;ve received your inquiry and will be in touch within 24 hours. We can&apos;t wait to welcome your teen to the Chicago Jewish Teen Camp family!
        </p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <p className="text-center text-xs text-gray-500">
        By submitting, you agree to be contacted about Chicago Jewish Teen Camp programs. We respect your privacy and never share your information.
      </p>
    </form>
  );
}
