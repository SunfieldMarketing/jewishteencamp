...
export const metadata = {
  title: 'Photo Gallery | California Jewish Teens',
  description:
    'Browse 75+ photos from California Jewish Teens summer camp - adventures, sports, trips, Shabbatons, and life-changing moments at our Beverly Hills, CA Jewish teen camp.',
};
      ...
      <section className="relative py-28 bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-4">
            {allPhotos.length}+ unforgettable memories from every summer at California Jewish Teens.
          </p>
      ...
      <section className="py-16 bg-gold text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-xl mb-8">
            Enroll today and make your teen part of the California Jewish Teens story.
          </p>
