...
export const metadata = {
  title: 'About Our Camp | Chicago Jewish Teen Camp',
  description:
    'Learn about Chicago Jewish Teen Camp - our history, mission, facilities, staff, and the CGI camp network. A bold new concept in Jewish camping for teens ages 12–17 in Beverly Hills, CA.',
};
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            <div className="bg-gradient-to-r from-primary to-primary-light p-8 text-center text-white">
              <h2 className="text-3xl font-bold mb-2" style={{ fontFamily: 'Playfair Display, serif' }}>
                Ready to Join the Chicago Jewish Teen Camp Family?
              </h2>
