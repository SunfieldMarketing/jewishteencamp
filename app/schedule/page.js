...
export const metadata = {
  title: 'Schedule & Pricing | Chicago Jewish Teen Camp',
  description:
    'View the summer schedule, program dates, and pricing for Chicago Jewish Teen Camp. Boys Teen Camp, Girls Art & Adventure, and Pacific Northwest Adventure programs available.',
};
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-accent rounded-3xl p-8 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-6">
              We believe every teen deserves the Chicago Jewish Teen Camp experience. Financial aid and payment plans are available. Don&apos;t let budget be a barrier - reach out and we&apos;ll work something out.
            </p>
