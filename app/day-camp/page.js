...
export const metadata = {
  title: 'Day Camp Programs | Chicago Jewish Teen Camp',
  description:
    'Explore all programs at Chicago Jewish Teen Camp day camp - sports, adventures, trips, Jewish culture, overnight experiences, and more for teens ages 12–17 in Beverly Hills, CA.',
};
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              At Chicago Jewish Teen Camp, we combine the best elements of overnight camp with the convenience of a day camp. Extended hours, bi-weekly full-day trips, and special weekend Shabbatons create an immersive summer experience.
            </p>
          </div>
